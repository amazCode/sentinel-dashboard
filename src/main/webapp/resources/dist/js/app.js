...
function(a, o) {
    ...
    this.getRequestRecords = function (e) {
        return a({
          url: "app/" + e +"/requestrecord.json",
          method: "GET"
        })
      },
...
(app = angular.module("sentinelDashboardApp")).service("RequestRecordService", ["$http", 
function(a) {
	 this.getRequestRecords = function (e) {
	      return a({
	        url: "record/" + e +"/requestrecord.json",
	        method: "GET"
	      })
	    }
